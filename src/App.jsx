...
const App = () => {
    ...
    for (let i = 0; i < MAX_RETRIES; i++) {
      ...
      try {
        ...
        if (response.ok) {
          ...
          throw new Error(`API error: ${JSON.stringify(errBody)}`);
        }
      } catch (err) {
  ...
  <textarea
    ...
    onChange={(e) =>
      setSetupConfig({ ...setupConfig, simulatedUrlContent: e.target.value })
    }
      ...
      <div className="text-center mt-4">
        ...
        <div className="mt-6 p-4 border rounded-lg bg-gray-50">
          ...
          <p className="text-sm text-gray-600 mb-2">
            Paste your website URL below and click <strong>“Integrate Chatbot”</strong> to generate
            the embed code instantly.
          </p>
          ...
          <div className="flex gap-2 mb-3">
            ...
            <button
              onClick={() => {
                ...
                alert("✅ Chatbot embed code copied! Paste it into your website’s HTML.");
              }}
